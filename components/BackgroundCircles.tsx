...
export function BackgroundCircles() {
  return (
    ...
    >
      ...
      <div className="absolute border border-[#333333] rounded-full w-[300px] h-[300px] mt-52  opacity-80" />
      <div className="absolute border border-[#333333] rounded-full w-[500px] h-[500px] mt-52" />
      <div className="absolute border border-[#34ebcd] rounded-full w-[650px] h-[650px] mt-52 animate-pulse opacity-20" />
