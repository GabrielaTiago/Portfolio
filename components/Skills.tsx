  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="pt-[3%] max-w-[260px] h-min max-h-80 xss:max-w-[420px] xss:max-h-[350px] md:max-w-fit md:max-h-[580px] xl:max-w-[580px] grid gap-3 xs:gap-5 grid-cols-5 xss:grid-cols-6 lg:grid-cols-7 overflow-x-hidden overflow-y-scroll scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#32a889]/40"
      >
        {skills.map((skill) => {
